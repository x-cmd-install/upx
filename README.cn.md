...
[![x-cmd/install — upx Code Quality Monitoring Repo Card](https://repo.x-cmd.io/upx.svg?lang=zh)](https://x-cmd.com/install/upx)
...
合计: **203,607** 行代码（覆盖前 5 种语言、共 **583** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| CHeader | 110,048 | 7,163 | 2,588 | 195 |
| Cpp | 37,550 | 5,782 | 4,605 | 64 |
...
- **Star**: 17,887 · **Fork**: 1,525 · **开放 issue**: 863 · **贡献者**: 21

## 累计统计

- **发布数**: 24 · **已合并 PR**: 62 · **开放 PR**: 0 · **已关闭 issue**: 842 · **开放 issue**: 21 · **提交数**: 4837

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-22 | 1 | 0 | 0 | 10 | 1 | 12 |
| last60d | 2026-07-23 | 1 | 1 | 0 | 19 | 1 | 39 |
| 90d | 2026-06-23 | 1 | 5 | 0 | 24 | 2 | 61 |
| last180d | 2026-03-25 | 2 | 25 | 0 | 37 | 4 | 169 |
| 360d | 2025-09-26 | 4 | 25 | 0 | 62 | 5 | 306 |
| last720d | 2024-10-01 | 7 | 25 | 0 | 127 | 7 | 172 |
...
upx 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `upx` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/upx.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260921.yml` · 2026-09-21T03:36:45Z._
